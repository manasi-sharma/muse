...
class DiffusionConvActionDecoder(ActionDecoder):
    ...
    def get_default_decoder_params(self) -> d:
        ...
        return base_prms & d(
            ...
            lang_mode = 't5_sentence', # added language to condition on, options are 'voltron', 'clip', 't5', 'distilbert / roberta' -Manasi
            lang_dim = lang_mode_to_dim['t5_sentence'], # added language to condition on -Manasi
        )
