...
from cfgs.exp_hvs.pusht import bc_rnn_lang
from cfgs.model import dp_conv_1d
from cfgs.trainer import ema
from configs.fields import Field as F
from muse.utils.general_utils import dc_skip_keys

export = dc_skip_keys(bc_rnn_lang.export, 'model') & d(
    use_ema=False,
    horizon=16,
    exp_name='push_t/lang_voltron_seed42_posact{?use_keypoint:-kp}_{?seed:s{seed}_}b{batch_size}_h{horizon}'
